...
from ...models import db, Pump_model
import sqlalchemy

namespace = Namespace('pump_models', 'Pump Models Endpoints')

entity_class = Pump_model
table_name = 'pump_models'
url_pre = ('/' + table_name)
required_attributes = ('tag_name', 'current_value')

post_device_model = namespace.model('Pump Model',{
    'make': fields.String(
...
# device_model = namespace.model('Motor Device',{
#     'id': fields.Integer(
