...
namespace = Namespace('motors', 'Motor Endpoints')
...
post_device_model = namespace.model('Motor Device',{
    'tag_name': fields.String(
        description = 'Tag name for specific device'
    ),
    'max_speed': fields.Integer(
        description = 'Maximum Rated Speed'
    ),
    'model': fields.String(
        description = 'Motor Manufacturer Model'
    ),
    'pump_id': fields.Integer(
        description = 'Asset ID of connected pump'
    ),
})
